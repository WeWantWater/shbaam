...
def outCSV(times,ptimes,ocx):
    ...
    print("Success! {} has been written".format(ocx))

def outNC(tot,ilons,ilats,avgs,swes,onx,ifns):
    ...
    print("SUCCESS! {} has been written".format(ifns[4]))
...
if __name__ == "__main__":
    ...
    outNC(tot,ilons,ilats,avgs,swes,onx,ifns)
